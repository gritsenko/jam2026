...
([docs/planned/sell-towers.md](docs/planned/sell-towers.md)); **пер-левел
волны/сложность** — `levelId` выбирает ростер/механики уровня, но скрипт волн от
уровня не зависит (все узлы играют общий `WAVES`); внутрисессионное **SP-дерево и
трата «Чертежей»** — стретчи мета-кампании
